...
class IntegrationPluginEnergySimulation: public IntegrationPlugin
{
    ...
    Q_PLUGIN_METADATA(IID "io.nymea.IntegrationPlugin" FILE "integrationpluginenergysimulation.json")
    Q_INTERFACES(IntegrationPlugin)

public:
    explicit IntegrationPluginEnergySimulation(QObject *parent = nullptr);
    ~IntegrationPluginEnergySimulation() = default;
